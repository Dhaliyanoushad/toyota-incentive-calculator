  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 pb-5">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-toyota-black">Sales Record Ledger</h1>
        ...
        <div className="flex gap-2 self-start sm:self-center">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-toyota-red hover:bg-red-700 text-toyota-white px-4 py-2.5 rounded text-xs font-bold uppercase transition-colors tracking-wider shadow cursor-pointer disabled:opacity-50"
          >
